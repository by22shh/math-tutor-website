...
const faqs = [
  ...
  },
  {
    ...
    answer: "Нет, все необходимые учебные материалы, задачники и пробные варианты ОГЭ я предоставляю бесплатно."
  },
  {
  ...
  },
  {
    ...
    answer: "При регулярных занятиях и выполнении домашних заданий гарантирую значительное улучшение результатов. 95% моих учеников сдают ОГЭ на 4 и 5!"
  }
];
